    ...
    <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200/50 shadow-lg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          {/* Logo and Brand */}
          <div className="flex items-center space-x-4 cursor-pointer group" onClick={() => onNavigate('setup')}>
            <div className="w-12 h-12 flex-shrink-0 transform transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
              <SchedulerPlanLogo />
            </div>
            <div className="flex flex-col">
              <span className="text-2xl font-extrabold bg-gradient-to-r from-brand-blue-900 via-brand-blue-700 to-brand-orange-500 bg-clip-text text-transparent animate-gradient">
                SchedulerPlan
              </span>
          ...
          <div className="hidden md:flex items-center space-x-2">
            <button
              ...
              className={`flex items-center space-x-2 px-5 py-2.5 rounded-xl transition-all duration-300 transform ${
            ...
            >
              <GraduationCap className={`w-5 h-5 ${currentView === 'setup' || currentView === 'results' ? 'animate-pulse' : ''}`} />
              <span className="font-semibold">Horarios Universitarios</span>
            </button>
            <button
            ...
            >
              <Calendar className={`w-5 h-5 ${currentView === 'personal' ? 'animate-pulse' : ''}`} />
              <span className="font-semibold">Calendarios Personales</span>
            </button>
            <button
            ...
            >
              <Star className={`w-5 h-5 ${currentView === 'reviews' ? 'animate-pulse' : ''}`} />
