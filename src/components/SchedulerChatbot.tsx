...
//       // La clave GEMINI_API_KEY ya se toma de import.meta.env.VITE_GEMINI_API_KEY
...
//       `${course.id} | ${course.name} | ${course.credits} créditos | ${course.schedule.join(', ')}`
//     ).join('\n');
...
//     const courseLinePattern = /^[A-Z0-9]+\s*\|\s*[^|]+\s*\|\s*\d+\s*créditos\s*\|\s*.*$/gim;
...
//           className="fixed bottom-6 right-6 z-50 p-4 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all duration-300 hover:scale-110"
