        ...
        {showTextInput && (
          <div className="mb-6 bg-purple-50 dark:bg-purple-900/20 rounded-lg p-6 border border-purple-200 dark:border-purple-800">
            ...
            <div className="flex justify-end space-x-3 mt-4">
              ...
              <button onClick={parseTextInput} disabled={!textInput.trim()} className="px-4 py-2 bg-brand-orange-500 dark:bg-brand-orange-600 text-white rounded-md hover:bg-brand-orange-600 dark:hover:bg-brand-orange-700 disabled:bg-gray-300 dark:disabled:bg-gray-600 disabled:cursor-not-allowed transition-colors">
                Procesar texto
              </button>
            </div>
          </div>
